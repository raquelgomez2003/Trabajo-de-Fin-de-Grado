...
# ── Artifact filter parameters per signal type ───────────────────────────────
# bandpass disabled for ECG/PPG/RESP — Biopac exports in various units and
# the Butterworth filter can distort or zero out signals in some unit ranges.
# Jump-based artifact detection in filters.py handles cleanup instead.
SIGNAL_FILTER_PARAMS: dict[str, dict] = {
    "ECG":  {"bandpass": None,          "savgol": None},
    "BVP":  {"bandpass": None,          "savgol": None},
    "EMG":  {"bandpass": None,          "savgol": None},
    "PPG":  {"bandpass": None,          "savgol": None},
    "EDA":  {"bandpass": None,          "savgol": (51, 3)},
    "GSR":  {"bandpass": None,          "savgol": (51, 3)},
    "RESP": {"bandpass": None,          "savgol": None},
    "SKT":  {"bandpass": None,          "savgol": (101, 2)},
    "TEMP": {"bandpass": None,          "savgol": (101, 2)},
    "ACC":  {"bandpass": None,          "savgol": None},
    "HR":   {"bandpass": None,          "savgol": (11, 2)},
    "_default": {"bandpass": None, "savgol": None},
}